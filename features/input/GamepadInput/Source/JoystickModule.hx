package;
import format.swf.Data.Gradient;
 ...
 * @author larsiusprime
 */
class JoystickModule implements IModule
{

	public function new(
		axisMove:Joystick->Int->Float->Void,
		buttonDown:Joystick->Int->Void,
		buttonUp:Joystick->Int->Void,
		connect:Joystick->Void,
		disconnect:Joystick->Void,
		hatMove:Joystick->Int->JoystickHatPosition->Void,
		ballMove:Joystick->Int->Float->Void
	) 
	{
		__onJoystickAxisMove = axisMove;
		__onJoystickButtonDown = buttonDown;
		__onJoystickButtonUp = buttonUp;
		__onJoystickConnect = connect;
		__onJoystickDisconnect = disconnect;
		__onJoystickHatMove = hatMove;
		__onJoystickTrackballMove = ballMove;
	}
	
	private var __onJoystickAxisMove:Joystick->Int->Float->Void;
	private var __onJoystickButtonDown:Joystick->Int->Void;
	private var __onJoystickButtonUp:Joystick->Int->Void;
	private var __onJoystickConnect:Joystick->Void;
	private var __onJoystickDisconnect:Joystick->Void;
	private var __onJoystickHatMove:Joystick->Int->JoystickHatPosition->Void;
	private var __onJoystickTrackballMove:Joystick->Int->Float->Void;
	...
	public function onJoystickAxisMove (joystick:Joystick, axis:Int, value:Float):Void { 
		__onJoystickAxisMove(joystick, axis, value);
	};
	...
	public function onJoystickButtonDown (joystick:Joystick, button:Int):Void { 
		__onJoystickButtonDown(joystick, button);
	};
	...
	public function onJoystickButtonUp (joystick:Joystick, button:Int):Void { 
		__onJoystickButtonUp(joystick, button);
	};
	...
	public function onJoystickDisconnect (joystick:Joystick):Void { 
		__onJoystickDisconnect(joystick);
	};
	...
	public function onJoystickHatMove (joystick:Joystick, hat:Int, position:JoystickHatPosition):Void { 
		__onJoystickHatMove(joystick, hat, position);
	};
	...
	public function onJoystickTrackballMove (joystick:Joystick, trackball:Int, value:Float):Void { 
		__onJoystickTrackballMove(joystick, trackball, value);
	};
